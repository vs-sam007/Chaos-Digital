          ...
          >
            {solutions.map((solution, index) => (
              <motion.div
                ...
                className="flex items-start gap-4 p-6 rounded-2xl bg-void/5 border border-void/10 hover:border-lime/30 transition-colors group"
              >
                <CheckCircle2 className="w-8 h-8 text-lime flex-shrink-0 group-hover:scale-110 transition-transform" />
                <p className="text-lg md:text-xl text-void font-medium">
                  {solution}
                </p>
              </motion.div>
            ))}
