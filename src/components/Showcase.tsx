  ...
  return (
    <section className="relative py-32 bg-void overflow-hidden border-t border-white/5">
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="flex-1 flex justify-center items-center gap-4 h-[400px]">
          <InfiniteSlider direction='vertical' className="h-full">
            <img
              ...
              className='aspect-square w-[150px] rounded-[4px]'
            />
            <img
          ...
          <InfiniteSlider direction='vertical' reverse className="h-full">
            <img
