      ...
      <div className="pt-32 pb-16 md:pt-48 md:pb-32 px-6">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="flex flex-wrap items-center gap-2 text-offwhite/50 mb-12 text-sm font-semibold uppercase tracking-wider">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-lime">{service.title}</span>
          </div>

          <div className="flex flex-col lg:flex-row gap-16 items-start">
            <div className="w-full lg:w-2/3">
              <div className="w-24 h-24 bg-lime/10 border border-lime/20 rounded-3xl flex items-center justify-center mb-8">
                 <IconComponent className="w-12 h-12 text-lime" />
              </div>
              ...
              <h2 className="text-2xl md:text-3xl font-medium text-lime mb-8">
                {service.subtitle}
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
                <div>
                  <h3 className="text-3xl font-bold uppercase tracking-tighter mb-8 border-b border-white/10 pb-4">
                    What's <span className="text-lime">Included</span>
                  </h3>
                ...
                <div>
                  <h3 className="text-3xl font-bold uppercase tracking-tighter mb-8 border-b border-white/10 pb-4">
                    The <span className="text-lime">Deliverables</span>
                  </h3>
                  <ul className="space-y-4">
            ...
            <div className="w-full lg:w-1/3 sticky top-32">
              <div className="bg-white/5 border border-white/10 rounded-3xl p-8 flex flex-col items-center text-center">
                <h3 className="text-3xl font-bold uppercase tracking-tighter mb-4">
                  Ready to <span className="text-lime">Dominate?</span>
                </h3>
                ...
                <Link 
                  href="/#contact" 
                  className="w-full py-4 bg-lime text-void font-bold uppercase tracking-wider rounded-xl hover:shadow-[0_0_30px_rgba(204,255,0,0.3)] transition-all flex items-center justify-center gap-2 group"
                >
                  Book Discovery Call
